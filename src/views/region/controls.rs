...
pub fn region_controls_ui(
    ...
    egui::Window::new("title")
        ...
        .show(ctx, |ui| {
            ui.heading("Region View");
            ui.label(egui::RichText::new("2000 baris — zoom/pan, seed infections, OPV campaigns").small());
    ...
    egui::Window::new("Simulation Controls")
        ...
        .show(ctx, |ui| {
            ...
            ui.collapsing("Population (on reset)", |ui| {
                ...
                if ui.add(egui::Slider::new(&mut num_nbhd, 1.0..=max_baris).text("Neighborhoods")).changed() {
